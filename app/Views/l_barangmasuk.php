...
<div class="card">
   <div class="card-body">
      <div class="table-responsive">
         ...
         <table id="tbl_barang_masuk" class="table w-100">
            <thead>
               <tr>
                  <th>No</th>
                  <th>Faktur</th>
   ...
   $(document).ready(function() {
         ...
         columns: [{
            ...
            },
            {
               ...
               "mRender": function(faktur) {
                  return '<button class="btn btn-xs btn-danger text-bold hapus" data-id="' + faktur + '"><i class="fa fa-trash-alt mr-1"></i>HAPUS</button>';
               },
      ...
      $(document).on('click', '.hapus', function(e) {
         ...
         Swal.fire({
            ...
            if (result.value) {
               $.ajax({
                  url: "<?= base_url('barang/masuk') ?>/" + faktur,
                  type: "delete",
                  dataType: "json",
                  beforeSend: function() {
                     // 
